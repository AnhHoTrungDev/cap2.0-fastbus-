...
insert into seat(seat_name,seat_floor) values
(N'A1D',1),(N'A2D',1),(N'A3D',1),(N'A4D',1),(N'A5D',1),(N'A6D',1),
(N'B1D',1),(N'B2D',1),(N'B3D',1),(N'B4D',1),(N'B5D',1),(N'B6D',1),
(N'C1D',1),(N'C2D',1),(N'C3D',1),(N'C4D',1),(N'C5D',1),(N'C6D',1),
(N'A1T',2),(N'A2T',2),(N'A3T',2),(N'A4T',2),(N'A5T',2),(N'A6T',2),
(N'B1T',2),(N'B2T',2),(N'B3T',2),(N'B4T',2),(N'B5T',2),(N'B6T',2),
(N'C1T',2),(N'C2T',2),(N'C3T',2),(N'C4T',2),(N'C5T',2),(N'C6T',2)
...
insert into route (route_start_palce,route_end_pace) values
(1,2),(1,3),(1,4),(1,5),(1,6),(2,1),(3,1),(4,1),(5,1)

insert into trip (trip_route_id,trip_bus_id,trip_date,trip_start_time) values
(1,10,'09-29-2019','17:30:00'),
(2,11,'09-29-2019','17:30:00'),
(3,12,'09-29-2019','17:30:00'),
(4,13,'09-29-2019','17:30:00'),
(6,10,'09-29-2019','17:30:00'),
(7,11,'09-29-2019','17:30:00'),
(8,12,'09-29-2019','17:30:00'),
(9,13,'09-29-2019','17:30:00')