...
<ul
	...
	<li class="nav-item active">
		<a class="nav-link" href="#">
			<i class="fas fa-fw fa-tachometer-alt"></i> <span>Admin</span>
		</a>
	</li>
	...
	<li class="nav-item"><a class="nav-link collapsed" href="#"
		...
		aria-controls="collapseTwo" id="managerBusTrip"> <i class="fas fa-fw fa-cog"></i> <span>Quản Lý BS</span>
	</a>
		<div id="collapseTwo" class="collapse" aria-labelledby="headingTwo"
			data-parent="#accordionSidebar">
			<div class="bg-white py-2 collapse-inner rounded">
				<h6 class="collapse-header">Hành Động</h6>
				<a class="collapse-item" href="">Chấp Nhận BS Mới</a>
