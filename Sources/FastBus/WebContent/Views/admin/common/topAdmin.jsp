...
<link
	...
	rel="stylesheet">
<link href="<%=request.getContextPath()%>/Views/admin/vendor/datatables/dataTables.bootstrap4.min.css" rel="stylesheet">
<!-- Custom styles for this template-->
<link href="<%=request.getContextPath()%>/Views/admin/css/sb-admin-2.min.css" rel="stylesheet">

<link href="<%=request.getContextPath()%>/Views/admin/css/custom.css" rel="stylesheet">
